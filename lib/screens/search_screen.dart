...
import 'package:delivery/widgets/icon_text_widget.dart';
import 'package:delivery/widgets/ticket_tabs.dart';
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image:const DecorationImage(fit: BoxFit.cover,image: AssetImage("assets/sit.jpg")),
                        borderRadius: BorderRadius.circular(AppLayout.getHeight(12)),
                      ),
                    ),
                     Gap(AppLayout.getHeight(12)),
                    AutoSizeText("20% discount on the early booking of this flight. Dont't miss. ",
